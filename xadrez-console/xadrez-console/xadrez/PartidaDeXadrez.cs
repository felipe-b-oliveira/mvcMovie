...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public PartidaDeXadrez()
        {
            CriarTabuleiro(8, 8);
            DefinirTurno(1);
            DefinirJogadorAtual(Cor.Branca);
        ...
        private void CriarTabuleiro(int linhas, int colunas)
        {
        ...
        private void DefinirJogadorAtual(Cor cor)
        {
            jogadorAtual = cor;
        }
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            { //!Negação. Se não existe Movimentos Possiveis
